      ...
      <div class="container d-inline-flex flex-row">
        ...
        <div class="col-md-4 ">
          <div class="align-items-start flex-row ">
            <a href="<?php echo e(route('events.index', $event)); ?>" class="btn btn-primary" role="button">Buy Tickets</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/events/show.blade.php ENDPATH**/ ?>