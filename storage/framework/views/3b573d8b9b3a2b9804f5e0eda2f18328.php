...
<div class="container-xxl py-2">
  <a href="<?php echo e(route('admin.events.create')); ?>" class="btn-link btn-lg mb-2 text-decoration-none"><h4>Add a Event<h4></a>
      ...
      <div class="col-md-4 py-2 my-3">
        <div class="card">
          ...
          <div class="align-items-end py-2 ps-2">
           ...
           <a href="<?php echo e(route('admin.events.show', $event)); ?>" class="btn-link btn-lg my-3 py-2 text-decoration-none bg-primary"><h5>Buy Tickets<h4></a>
           <a href="<?php echo e(route('admin.events.edit', $event)); ?>" class="btn-link btn-lg my-3 py-2 text-decoration-none"><h5>Edit an Event<h4></a>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/resources/views/admin/events/index.blade.php ENDPATH**/ ?>